...
const TreasureHunt = () => {
    ...
    const fetchBalances = useCallback(
        ...
        [voyTokenAddress] // Removed 'voyTokenABI' from the dependency array
    )
    ...
    useEffect(() => {
        const init = async () => {
            if (typeof window !== "undefined" && window.ethereum) {
                try {
                    ...
                    await fetchBalances(newProvider, newSigner, newAccount) // Call memoized function
                } catch (error) {
        ...
        init()
    }, [contractAddress, fetchBalances]) // fetchBalances is now stable due to useCallback
                    ...
                    {showConfirm && (
                        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                            <div className="p-6 text-center bg-white rounded-lg shadow-lg">
                                <p className="mb-4">
                                    Would you like to confirm this location? Selecting an incorrect
                                    <p className="mb-4">
                                        location will deduct 100 VOY from your balance.
                                    </p>
                                    <p className="mb-4">
                                        Your chosen location is {countryName} . Shall we proceed?
                                    </p>
                                </p>
