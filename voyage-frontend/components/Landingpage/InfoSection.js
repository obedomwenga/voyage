  ...
  return (
    <div className="h-screen bg-cover bg-center" style={{ backgroundImage: 'url("/Jamaica.png")' }}>
      <div className="flex flex-col items-center justify-center h-full text-center text-white bg-black bg-opacity-50 px-4">
        <h2 className="text-2xl sm:text-3xl font-bold mb-8">Welcome to Voyage</h2>
        <p className="text-base sm:text-lg mb-16 w-50">
        ...
        <p className="text-base sm:text-lg mb-16 justify-center">
        ...
        <p className="text-base sm:text-lg mb-16">
